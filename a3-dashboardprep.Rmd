...
```{r load census data}
# Add key to .Renviron
Sys.setenv(CENSUS_KEY="e92b2039e7923fc6b83bd4c49d5a075715c567c8")
# Reload .Renviron
readRenviron("~/.Renviron")

incometract16 <- getCensus(name = "acs/acs5", key = Sys.getenv("CENSUS_KEY"), vintage = "2016", vars = "B19013_001E",
region = "tract:*", regionin = "state:06+county:001,013,041,055,075,081,085,095,097")

colnames(incometract16)[4] <- "Tract"

incomecounty16 <- getCensus(name = "acs/acs5", key = Sys.getenv("CENSUS_KEY"), vintage = "2016", vars = "B19013_001E",
